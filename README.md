...
2. Background Image (if desired)
3. Colorscheme 
4. Console: Data callout, plot bounds, background image options


## heatmaps_basic_image_overlay
Accepts csv of points and intensity and provides you options to decide plot bounds, provide background image and callout data on the plot.
